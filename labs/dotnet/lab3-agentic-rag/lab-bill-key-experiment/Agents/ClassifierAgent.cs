...
public static class ClassifierAgent
{
    private const string Instructions = """
        ...
        **COUNT_AGENT**: Questions asking for a count or number
        ...
        **SEMANTIC_SEARCH_AGENT**: Queries looking for similar issues, solutions, or general information
        ...
        1. **COUNTING first**: If question has "how many", "count", "total", "number of" -> COUNT_AGENT (even if "and" present - those are filters!)
        ...
        6. **YES_NO_AGENT** (explicit yes/no questions expecting boolean answer)
