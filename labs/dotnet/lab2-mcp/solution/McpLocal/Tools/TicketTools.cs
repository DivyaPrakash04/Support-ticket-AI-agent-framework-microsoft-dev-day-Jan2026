...
// TEMPLATE: This demonstrates ticket tools via STDIO transport
//
// ═══════════════════════════════════════════════════════════════════════════════
// HOW TO ENABLE THIS TEMPLATE:
// ═══════════════════════════════════════════════════════════════════════════════
// 1. Uncomment all the code below
// 2. Register TicketStore in Program.cs:
//    builder.Services.AddSingleton<TicketStore>();
// 3. The tools will be automatically discovered via [McpServerToolType] attribute
// ═══════════════════════════════════════════════════════════════════════════════
...
/// Uncomment this class to enable ticket functionality in the local MCP server.
/// </summary>
[McpServerToolType]
